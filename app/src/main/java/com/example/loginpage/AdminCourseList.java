...
public class AdminCourseList extends AppCompatActivity {
    ...
    private Button btnBackToAdminPg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBackToAdminPg = (Button) findViewById(R.id.btnBackToAdminPg);
    ...
    public void BackToAdminPg(View view) {
        startActivity(new Intent(AdminCourseList.this, AdminPg.class));
    }
}